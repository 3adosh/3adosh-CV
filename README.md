...
<body>
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <p>Completed a course on Data Entry Skills: A Complete Data Entry Course from Scratch, Enhance my skills in using AI tools and using advanced skills in Microsoft Excel and Google Workspace : </p>
        </div>
